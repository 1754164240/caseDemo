...
ALL_ENUM_TOOLS = [query_enum_values_tool, query_linkage_rules_tool]
ALL_FIELD_TOOLS = [query_field_variables_tool]
ALL_FUNCTION_TOOLS = [query_function_info_tool, query_risk_config_tool]
