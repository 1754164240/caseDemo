...
- `backend/scripts/run_approval_migration.py` - 迁移执行脚本
- `backend/scripts/test_approval.py` - 审批功能测试脚本
...
```bash
cd backend
.venv\Scripts\python.exe -m scripts.test_approval
```
...
- [测试脚本](../backend/scripts/test_approval.py)
